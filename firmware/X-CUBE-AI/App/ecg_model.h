/**
  ...
  ******************************************************************************
  */
#ifndef AI_ECG_MODEL_H
#define AI_ECG_MODEL_H

#include "ecg_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ECG_MODEL_MODEL_NAME          "ecg_model"
#define AI_ECG_MODEL_ORIGIN_MODEL_NAME   "energy_ecg_model_lr"

/******************************************************************************/
#define AI_ECG_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ECG_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ECG_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ECG_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_ECG_MODEL_IN \
  ai_ecg_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ECG_MODEL_IN_SIZE { \
  AI_ECG_MODEL_IN_1_SIZE, \
}
#define AI_ECG_MODEL_IN_SIZE_BYTES { \
  AI_ECG_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_ECG_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ECG_MODEL_IN_1_HEIGHT      (1000)
#define AI_ECG_MODEL_IN_1_CHANNEL     (1)
#define AI_ECG_MODEL_IN_1_SIZE        (1000)
#define AI_ECG_MODEL_IN_1_SIZE_BYTES  (4000)

/******************************************************************************/
#define AI_ECG_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ECG_MODEL_OUT \
  ai_ecg_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ECG_MODEL_OUT_SIZE { \
  AI_ECG_MODEL_OUT_1_SIZE, \
}
#define AI_ECG_MODEL_OUT_SIZE_BYTES { \
  AI_ECG_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_ECG_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ECG_MODEL_OUT_1_CHANNEL     (3)
#define AI_ECG_MODEL_OUT_1_SIZE        (3)
#define AI_ECG_MODEL_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_ECG_MODEL_N_NODES (13)
 ...
 * @ref ai_ecg_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_ecg_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ecg_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ecg_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ECG_MODEL_*
 * defines into file @ref ecg_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_ecg_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ECG_MODEL_H */
